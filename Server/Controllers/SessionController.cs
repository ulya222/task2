...
public class SessionController : ControllerBase
{
    ...
    public SessionController(DataVaultDbContext context, IConfiguration config)
    {
        _context = context;
        _config = config;
    }
    ...
    public async Task<IActionResult> Login([FromBody] LoginRequest request)
    {
        ...
        _context.ActivityLogs.Add(new ActivityLog { UserId = user.Id, Action = "Login", Entity = "AppUser", EntityId = user.Id, Details = $"Вход {user.Login}", CreatedAt = DateTime.UtcNow });
